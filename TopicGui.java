...

{
			...
			if (buttonChoose2 == JFileChooser.APPROVE_OPTION)
			{
				...
				try {
					...
					while (newScan2.hasNextLine())
					{
						...
						//printFiles();
						System.out.println(tm.TenFreq(convertarray1(), 10));
						System.out.println(tm.TenFreq(convertarray2(), 10));
						tm.arrayCheck(convertarray1(),convertarray2());
	...
	public void printingOutArrayLists() {
		...
		List1.addAll(tm.removeStopWords1(str,stop));
		ArrayList<String> List2 = new ArrayList<>();
		List2.addAll(tm.removeStopWords2(str2,stop));
